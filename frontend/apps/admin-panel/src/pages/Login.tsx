    ...
    >
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          <h1 style={{ fontSize: 24 }}>Panel Administración</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: 13 }}>Solo personal autorizado</p>
        </div>
        <Card>
          <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <Button type="submit" loading={submitting} fullWidth size="lg">Entrar →</Button>
          </form>
        </Card>
      </div>
    </div>
