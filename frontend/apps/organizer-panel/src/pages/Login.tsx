    ...
    <div style={{ position: 'relative', width: cellSize * 8, height: cellSize * 8, margin: '0 auto' }}>
      ...
      <div
        style={{
          ...
          top: highlight ? `${highlight.to[0] * cellSize + cellSize / 2 - 26}px` : '50%',
          width: 32,
          height: 48,
...
const Field = ({ label, type = 'text', placeholder = '', hint = '', error = '', value, onChange, name, autoComplete, rightSlot }: FieldProps) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
      ...
      {(hint || error) && (
        <span style={{ fontSize: 11, color: error ? 'var(--cq-error, #e05a5a)' : 'var(--cq-text-muted, #4a4d40)', lineHeight: 1.4 }}>
          {error || hint}
        </span>
      )}
    </div>
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p style={{ marginTop: 20, fontSize: 14, color: 'var(--cq-text-dim, #7a7d6e)', lineHeight: 1.6 }}>
      ...
      >
        ...
        <div style={{ maxWidth: 420, width: '100%', margin: '0 auto', animation: 'cq-slide-up 0.4s ease' }}>
          ...
          <p style={{ fontSize: 13, color: 'var(--cq-text-dim, #7a7d6e)', marginBottom: 28 }}>
